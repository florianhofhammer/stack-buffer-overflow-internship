...
Description:    This script tries to exploit the buffer overflow vulnerability in the vulnerable_advanced executable
                ...
                It was extended by code which allows not only to spawn a shell but also to elevate the privileges if
                the SUID bit is set on the vulnerable executable.
'''
...
print('setreuid() is at ' + hex(setreuid_addr))
